...
## Сравнение подходов:
- **Хвостовая рекурсия** - максимальная производительность
- **Stream** - баланс производительности и читаемости  
- **Модульный подход** - лучшая поддерживаемость и тестируемость
